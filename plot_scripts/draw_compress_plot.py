...
LOGGER = logging.getLogger("sempic.plot_scripts.draw_compress_plot")
...
def main() -> None:
    args = parse_args()
    run_dir = allocate_run_dir("./logs/draw_compress_plot", None)
    with RuntimeContext(
        entrypoint="draw_compress_plot",
        run_dir=run_dir,
        config_file=None,
        ...
        LOGGER.info("Saved to ablation_niah.pdf and ablation_niah.png")
